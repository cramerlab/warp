...
{
    // Modified from OpenTK.
    // For original license, see https://github.com/opentk/opentk/blob/develop/src/OpenTK/Math/Quaternion.cs
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public Quaternion(float3 eulerAngles)
        ...
        public float Length
        {
            get
            {
                return (float)System.Math.Sqrt(W * W + Xyz.LengthSq());
            }
        }
        ...
        /// <returns>The equivalent Quaternion</returns>
        public static Quaternion FromEulerAngles(float3 eulerAngles)
        {
        ...
        public static void FromEulerAngles(ref float3 eulerAngles, out Quaternion result)
        {
